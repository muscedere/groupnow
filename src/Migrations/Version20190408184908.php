 ...
 */
final class Version20190408184908 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad ADD category_id INT DEFAULT NULL, DROP created_at');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad ADD created_at DATETIME DEFAULT NULL, DROP category_id');
    }
}
